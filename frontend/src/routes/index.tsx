      ...
      {open && (
        <div className="border-t border-slate-100 bg-white px-6 py-4 md:hidden">
          <div className="flex flex-col gap-3">
            ...
            <a href="/login" className="py-2 text-slate-700">
              Sign In
            </a>
...
const features = [
  {
    ...
    desc: "Centralized client profiles, history, and document storage.",
    tone: "blue",
  },
  {
    icon: IdCard,
    title: "Employee Tracking",
    desc: "Manage performance, attendance, and internal growth.",
    tone: "purple",
  },
  {
    icon: Network,
    title: "Project Oversight",
    desc: "High-level visibility across all active business initiatives.",
    tone: "blue",
  },
  {
    icon: ListChecks,
    title: "Task Workflow",
    desc: "Granular task assignment with automated dependencies.",
    tone: "blue",
  },
  {
    icon: Lock,
    title: "Role Based Access",
    desc: "Precise permission controls for every user level.",
    tone: "purple",
  },
  {
    icon: MessageSquare,
    title: "Internal Messaging",
    desc: "Direct and channel-based secure communication.",
    tone: "blue",
  },
  {
    icon: Bell,
    title: "Smart Alerts",
    desc: "Real-time triggers for critical business updates.",
    tone: "blue",
  },
  {
    icon: LineChart,
    title: "Deep Analytics",
    desc: "Data-driven insights to optimize your bottom line.",
    tone: "purple",
  },
];
...
function Features() {
  return (
    <section id="launchpad" className="scroll-mt-24 bg-slate-50/60 py-20">
...
const roles = [
  {
    ...
    blob: "bg-blue-100",
    items: [
      "Full business financial oversight",
  ...
  },
  {
    ...
    blob: "bg-purple-100",
    items: [
      "Personalized task queue",
      "Internal team collaboration",
      "Timesheet & PTO tracking",
    ],
...
function Roles() {
  return (
    <section id="resources" className="scroll-mt-24 bg-slate-50/60 py-20">
      <div className="mx-auto max-w-7xl px-6">
        ...
        <div className="mt-16 grid gap-8 lg:grid-cols-3">
          {roles.map((r) => (
            ...
            >
              <div
                className={`absolute -right-8 -top-8 h-32 w-32 rounded-full opacity-60 ${r.blob}`}
              />

              <div className="relative">
                <p className={`text-xs font-bold tracking-widest ${r.tagColor}`}>
                  {r.tag}
                </p>
      ...
      <div className="mx-auto max-w-7xl px-6">
        ...
        <div className="mt-14 grid gap-8 lg:grid-cols-3">
          {testimonials.map((t) => (
            <div
              key={t.name}
              className="rounded-2xl bg-white p-8 shadow-[0_4px_20px_-8px_rgba(15,23,42,0.08)]"
            >
...
const faqs = [
  {
    q: "What is ServiceDesk Pro?",
    a: "ServiceDesk Pro is an all-in-one platform for managing clients, projects, employees and communication for modern service businesses.",
  },
  {
    q: "Is my data secure?",
    a: "Yes. We use enterprise-grade encryption at rest and in transit, with SOC 2 compliant infrastructure and role-based access controls.",
  },
  {
    q: "Can I invite my clients?",
    a: "Absolutely. Each client gets a transparent portal to track milestones, approve documents and reach support directly.",
  },
  {
      ...
      <div className="mx-auto max-w-3xl px-6">
        ...
        <div className="mt-12 space-y-4">
          {faqs.map((f, i) => (
            <div
              key={f.q}
              className="overflow-hidden rounded-2xl bg-white shadow-[0_2px_12px_-4px_rgba(15,23,42,0.08)]"
            >
              <button
              ...
              {open === i && <div className="px-6 pb-5 text-slate-600">{f.a}</div>}
            </div>
          ))}
        </div>
      </div>
